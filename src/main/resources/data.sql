...
insert into coin(coinmarketcap_id,name,code,description) values(1027,'Ethereum','ETH','Ethereum is a decentralized open-source blockchain system that features its own cryptocurrency, Ether. ETH works as a platform for numerous other cryptocurrencies, as well as for the execution of decentralized smart contracts.');
